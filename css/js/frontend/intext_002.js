...
var $adtext = (function (window)
{
 ...
 var properties = {
  ...
  browserver: '31.0',
  browsersupport: '1',
  appsig: 'S20141407993127z',
  subscribe: '',
  subscribe2: '',
  sbstatus: '',
  supnow: '',
  checksb: 0,
  branduid: 'ae02f7f3c55c2993cf9910e32124821a|1407993127',
  browser: '?',
  ua: '?',
  version: '?',
  supportedMobileBrowser: 0,
  osname: '?',
  refer_url: 'http://localhost/nassa/',
  page_url: '?',
 ...
 function startup()
 {
  ...
  properties.userip = '180.149.12.209'; 
 ...
 if (0)
  ...
  {
   myAlert(0, 'userip 180.149.12.209 not supported. uip=' + properties.userip);
   return (0);
  }
...
function analyzePage()
{
 ...
 function setPageLocation()
 {
  ...
  try
   ...
   {
    properties.page_url=''; /* 'http://localhost/nassa/'; */
...
/* alert('fontsize='+s.fontSize+', height='+s.height+', lineheight='+s.lineHeight+',  objHeight='+objHeight); */
 ...
 function checkMouseOverAdBox()
 {
  ...
  var width = document.getElementById('q009dw2mt1pop').offsetWidth;
...
//    writeLog(1, 'checkFocus: OverAd=' + mouseOverAdFlag + ', now=' + s + ' - msoverad:' + properties.lastMouseAwayAd + '=' + (s - properties.lastMouseAwayAd));
 ...
 function doMouseClickq009dw2mt1()
 {
 ...
 function mouseOverPageText(obj)
 {
  ...
  spanid=obj.event.toElement.id; // eg q009dw2mt1_3, q009dw2mt1_4, ... q009dw2mt1_13 
     ...
     if (1==1 && dynamicColorMode ==1)
      {
       ...
       var css=getq009dw2mt1CSS(sc);
       span.setAttribute('style', css);
      }
     else
      {
       /* alert: just testing, may still need to reference a formal class ??? */
       span.className = 'q009dw2mt1';
      }


     span.id = 'q009dw2mt1' + "_" + properties.spancount;
     span.name='q009dw2mt1' + "_" + properties.spancount; 
...
function build_clickthru(domain, afid, ecb, ptclickflag, url)
{
 ...
 var textcolor=getq009dw2mt1Color();
...
/* begin new box build */
 ...
 function buildAdBoxHTMLV2(title, desc, vurl, clickurl, wpdesc,  wplink)
 {
  ...
  var wrapper = '<div id="intext_outer_wrapper" class="j413u9rs8649" style="text-decoration:none !important; z-index:'+z+'; overflow:visible;">'
...
function buildAdBoxArrowWrapper(boxHTML)
{
 ...
 function buildAdBoxHTMLV1(title, desc, vurl, clickurl, wpdesc,  wplink)
 {
  ...
  var wrapper = '<div class="j413u9rs8649" style="text-decoration:none !important; z-index:'+z+'; overflow:visible;">'
...
html+='<div style="border:0 !important; padding:0 !important; margin:0 !important; width:'+boxWidth+'px; height:'+boxHeight+'px; text-align:top !important;">';
 ...
 function init()
 {
  ...
  adpop_spinner_span.id = 'q009dw2mt1spinner';
  ...
  // setup adbox events
  // adpop_span.addEventListener("click",      doMouseClickq009dw2mt1,   false);
  addEvent(adpop_span, "click", doMouseClickq009dw2mt1);
  ...
  try
   {
    ...
    s.setAttribute('id', 'q009dw2mt1sup');
 ...
 function createIFrame()
 {
  ...
  gframe.id = 'q009dw2mt1frame';
  gframe.name = 'q009dw2mt1frame';
 ...
 function writeIFrame(html)
 {
  ...
  var iframe = document.getElementById('q009dw2mt1frame');
 ...
 function setupq009dw2mt1CSS()
 {
  writeLog(1, 'setupq009dw2mt1CSS()');
  ...
  // style.innerHTML = '.q009dw2mt1 { text-decoration:underline; font-weight:bold; background-color:#ff0000; }';
  // style.innerHTML= '.q009dw2mt1 { padding:0; margin:0; border-bottom:1px solid; text-decoration:none; font-weight:bold; cursor:pointer; background:url('+properties.pageprotocol+'://intext.nav-links.com/images/dotcover.png);}';
 ...
 if (method == 1) 
  {
    var rule='.q009dw2mt1 {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; '+uline+' color:'+config.linkColor+' !important; font-weight:normal; cursor:pointer; }';
   ...
   var style = document.createElement('style');
   style.type = 'text/css';
   style.styleSheet.cssText= '.j413u9rs8649  {padding:0 !important; margin:0 !important; display:block; xwidth:400px; xheight:200px;  z-index:2000000000; text-decoration:none !important;}';
   ...
   {
    // style.innerHTML = '.q009dw2mt1 {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; border-bottom:1px solid; text-decoration:underline; font-weight:bold; cursor:pointer; background:url('+properties.pageprotocol+'://'+config.coreDomain+'/images/dotcover.png);}';

    style.innerHTML = '.q009dw2mt1 {  display:inline !important; list-style:none; text-align:left !important; float:none; padding:0 !important; margin:0 !important; border:none !important; '+uline+' color:'+config.linkColor+' !important; font-weight:normal; cursor:pointer; }';

  document.getElementsByTagName('head')[0].appendChild(style);

 var style = document.createElement('style');
 style.type = 'text/css';
 style.innerHTML = '.j413u9rs8649  {padding:0 !important; margin:0 !important; display:block; xwidth:400px; xheight:200px;  z-index:2000000000; text-decoration:none !important;}';
 document.getElementsByTagName('head')[0].appendChild(style);
 ...
 function getq009dw2mt1CSS(linkcolor)
 {
  var css='';
