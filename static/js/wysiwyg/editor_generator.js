...
<div class="btn-toolbar m-b-sm btn-editor" data-role="editor-toolbar" data-target="'+editor_id+'">
  <div class="btn-group">
...
<div id="'+editor_id+'" class="form-control" style="overflow:scroll;height:150px;max-height:150px">
      Go ahead&hellip;
    </div>
